...
public class Validator {
     ...
     */
    public boolean isNameNotValid(@Nullable String name) { return name == null || name.trim().length() < 2; }
     ...
     */
    public boolean isEmailNotValid(@Nullable String email) { return email == null || !Patterns.EMAIL_ADDRESS.matcher(email).matches(); }
     ...
     */
    public boolean isPhoneNotValid(@Nullable String phone) { return phone == null || !Patterns.PHONE.matcher(phone).matches(); }
     ...
     */
    public boolean isPasswordNotValid(@Nullable String password) { return password == null || password.length() < 6; }
