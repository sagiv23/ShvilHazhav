...
| `DailyCheckWorker`         | Worker            | Periodic task (24h) for maintenance checks, such as birthday notifications.       |
...
- **Reliability**: Uses exact alarms and background workers to ensure critical medical alerts arrive
  on time.
