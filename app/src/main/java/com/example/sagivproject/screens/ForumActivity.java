...
public class ForumActivity extends AppCompatActivity {
    private Button btnToHomePage, btnToContact, btnToDetailsAboutUser, btnToExit, btnSendMessage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnToHomePage = findViewById(R.id.btnForumPageToHomePage);
        btnToContact = findViewById(R.id.btnForumPageToContactPage);
        btnToDetailsAboutUser = findViewById(R.id.btnForumPageToDetailsAboutUserPage);
        btnToExit = findViewById(R.id.btnForumPageToExit);
        btnSendMessage = findViewById(R.id.btnForumSendMessage);
        edtNewMessage = findViewById(R.id.edtForumNewMessage);
        recyclerForum = findViewById(R.id.recyclerForum);

        btnToHomePage.setOnClickListener(view -> startActivity(new Intent(this, HomePageActivity.class)));
