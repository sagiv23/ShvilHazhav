...
public class GameHomeScreenActivity extends AppCompatActivity {
    Button btnToHomePage, btnToContact, btnToDetailsAboutUser, btnFindEnemy, btnCancelFindEnemy, btnToExit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnToHomePage = findViewById(R.id.btnGameHomeScreenPageToHomePage);
        btnToContact = findViewById(R.id.btnGameHomeScreenPageToContactPage);
        btnToDetailsAboutUser = findViewById(R.id.btnGameHomeScreenPageToDetailsAboutUserPage);
        btnFindEnemy = findViewById(R.id.btnFindEnemy);
        btnCancelFindEnemy = findViewById(R.id.btnCancelFindEnemy);
        btnToExit = findViewById(R.id.btnGameHomeScreenPageToExit);
        TVStatusOfFindingEnemy = findViewById(R.id.TVStatusOfFindingEnemy);

        btnToHomePage.setOnClickListener(view -> startActivity(new Intent(GameHomeScreenActivity.this, HomePageActivity.class)));
    ...
    private void loadUserWins() {
        ...
        TextView winsText = findViewById(R.id.TVGameVictories);
