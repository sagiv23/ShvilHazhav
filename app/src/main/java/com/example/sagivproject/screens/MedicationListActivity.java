...
public class MedicationListActivity extends AppCompatActivity {
    Button btnToHomePage, btnToContact, btnToDetailsAboutUser, btnAddMedication, btnToExit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnToHomePage = findViewById(com.example.sagivproject.R.id.btnMedicationListPageToHomePage);
        btnToContact = findViewById(com.example.sagivproject.R.id.btnMedicationListPageToContactPage);
        btnToDetailsAboutUser = findViewById(com.example.sagivproject.R.id.btnMedicationListPageToDetailsAboutUserPage);
        btnAddMedication = findViewById(com.example.sagivproject.R.id.btnAddMedication);
        btnToExit = findViewById(com.example.sagivproject.R.id.btnMedicationListPageToExit);

        btnToHomePage.setOnClickListener(view -> startActivity(new Intent(MedicationListActivity.this, HomePageActivity.class)));
        ...
        recyclerViewMedications = findViewById(com.example.sagivproject.R.id.recyclerViewMedications);
    ...
    private void openMedicationDialog(Medication medToEdit, int index) {
        ...
        dialog.setContentView(com.example.sagivproject.R.layout.dialog_add_medication);
        dialog.setCancelable(true);

        EditText edtName = dialog.findViewById(com.example.sagivproject.R.id.edtMedicationName);
        EditText edtDetails = dialog.findViewById(com.example.sagivproject.R.id.edtMedicationDetails);
        EditText edtDate = dialog.findViewById(com.example.sagivproject.R.id.edtMedicationDate);
        Button btnConfirm = dialog.findViewById(com.example.sagivproject.R.id.btnAddMedicationConfirm);
        Button btnCancel = dialog.findViewById(com.example.sagivproject.R.id.btnAddMedicationCancel);
